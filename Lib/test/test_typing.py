...
class GenericTests(BaseTestCase):
    ...
    def test_pep695_generic_class_with_future_annotations_name_clash_with_global_vars(
        ...
        self.assertEqual(
            set(hints_for_C.values()), set(ann_module695.C.__type_params__)
        )
    ...
    def test_pep_695_generics_with_future_annotations_nested_in_function(self):
        ...
        self.assertEqual(
            set(results.hints_for_E.values()), set(results.E.__type_params__)
        )
        self.assertEqual(
        ...
        self.assertNotEqual(
            set(results.hints_for_E_meth.values()), set(results.E.__type_params__)
        )
        self.assertEqual(
            set(results.hints_for_E_meth.values()).intersection(
                results.E.__type_params__
            ),
            set(),
        )
