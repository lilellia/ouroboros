...
class FormatTest(unittest.TestCase):
    ...
    def test_negative_zero(self):
        ## default behavior
        self.assertEqual(f"{-0.0:.1f}", "-0.0")
        self.assertEqual(f"{-0.01:.1f}", "-0.0")
        self.assertEqual(f"{-0:.1f}", "0.0")  # integers do not distinguish -0

        ## z sign option
        self.assertEqual(f"{0.0:z.1f}", "0.0")
        self.assertEqual(f"{0.0:z6.1f}", "   0.0")
        self.assertEqual(f"{-1.0:z6.1f}", "  -1.0")
        self.assertEqual(f"{-0.0:z.1f}", "0.0")
        self.assertEqual(f"{0.01:z.1f}", "0.0")
        self.assertEqual(f"{-0:z.1f}", "0.0")  # z is allowed for integer input
        self.assertEqual(f"{-0.01:z.1f}", "0.0")
        self.assertEqual(f"{0.0:z.2f}", "0.00")
        self.assertEqual(f"{-0.0:z.2f}", "0.00")
        self.assertEqual(f"{0.001:z.2f}", "0.00")
        self.assertEqual(f"{-0.001:z.2f}", "0.00")

        self.assertEqual(f"{0.0:z.1e}", "0.0e+00")
        self.assertEqual(f"{-0.0:z.1e}", "0.0e+00")
        self.assertEqual(f"{0.0:z.1E}", "0.0E+00")
        self.assertEqual(f"{-0.0:z.1E}", "0.0E+00")
        ...
        self.assertEqual(f"{-00000.0:z.1f}", "0.0")
        self.assertEqual(f"{-0.0000000000:z.1f}", "0.0")

        self.assertEqual(f"{-00000.000001:z.2f}", "0.00")
        self.assertEqual(f"{-00000.0:z.2f}", "0.00")
        self.assertEqual(f"{-0.0000000000:z.2f}", "0.00")

        self.assertEqual(f"{0.09:z.1f}", "0.1")
        self.assertEqual(f"{-0.09:z.1f}", "-0.1")

        self.assertEqual(f"{-0.0: z.0f}", " 0")
        self.assertEqual(f"{-0.0:+z.0f}", "+0")
        self.assertEqual(f"{-0.0:-z.0f}", "0")
        self.assertEqual(f"{-1.0: z.0f}", "-1")
        self.assertEqual(f"{-1.0:+z.0f}", "-1")
        self.assertEqual(f"{-1.0:-z.0f}", "-1")

        self.assertEqual(f"{0.0j:z.1f}", "0.0+0.0j")
        self.assertEqual(f"{-0.0j:z.1f}", "0.0+0.0j")
        self.assertEqual(f"{0.01j:z.1f}", "0.0+0.0j")
        self.assertEqual(f"{-0.01j:z.1f}", "0.0+0.0j")

        self.assertEqual(f"{-0.0:z>6.1f}", "zz-0.0")  # test fill, esp. 'z' fill
        self.assertEqual(f"{-0.0:z>z6.1f}", "zzz0.0")
        self.assertEqual(f"{-0.0:x>z6.1f}", "xxx0.0")
        self.assertEqual(f"{-0.0:🖤>z6.1f}", "🖤🖤🖤0.0")  # multi-byte fill char
