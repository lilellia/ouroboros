...
class Rat:
    ...
    def __eq__(self, other):
        if self.__class__ != other.__class__:
            return NotImplemented
        return typed_approx_eq(self.numerator, other.numerator) and typed_approx_eq(
...
class Root:
    ...
    def __eq__(self, other):
        if self.__class__ != other.__class__:
            return NotImplemented
        return typed_approx_eq(self.base, other.base) and typed_approx_eq(
...
class FractionTest(unittest.TestCase):
    ...
    def testMixedMultiplication(self):
        ...
        self.assertTypedEquals(
            F(3, 2) * RectComplex(4, 3), RectComplex(6.0 + 0j, 4.5 + 0j)
        )
