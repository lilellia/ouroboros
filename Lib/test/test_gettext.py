...
GNU_MO_DATA_CORRUPT = base64.b64encode(
    bytes(
        [
            0xDE,
            0x12,
            ...
            0x00,
            0x00,
            0x00,  # Translation offset
            0x00,
            0x00,
            0x00,
            0x00,  # Hash table size
            0x2C,
            0x00,
            0x00,
            0x00,  # Hash table offset
            0x03,
            0x00,
            0x00,
            0x00,  # 1st message length
            0x2C,
            0x00,
            0x00,
            0x00,  # 1st message offset
            0x03,
            0x00,
            0x00,
            0x00,  # 1st trans length
            0xFF,
            0xFF,
            0xFF,
            0xFF,  # 1st trans offset (Modified to make it invalid)
            0x66,
            0x6F,
            0x6F,
            0x00,  # Message data
...
class ExpandLangTestCase(unittest.TestCase):
    def test_expand_lang(self):
        ...
        locales = {
            ...
            "cs@euro": ["cs@euro", "cs"],
            "cs_CZ.ISO8859-2": ["cs_CZ.ISO8859-2", "cs_CZ", "cs.ISO8859-2", "cs"],
            "cs_CZ@euro": ["cs_CZ@euro", "cs@euro", "cs_CZ", "cs"],
            "cs.ISO8859-2@euro": ["cs.ISO8859-2@euro", "cs@euro", "cs.ISO8859-2", "cs"],
...
class FindTestCase(unittest.TestCase):
    ...
    def test_find_with_env_vars(self):
        ...
        for var in ("LANGUAGE", "LC_ALL", "LC_MESSAGES", "LANG"):
            ...
            result = gettext.find(
                "mofile", localedir=os.path.join(self.tempdir, "locale")
            )
