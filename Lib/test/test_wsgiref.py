    ...
    def testRaisesControlCharacters(self):
        for c0 in control_characters_c0():
            with self.subTest(c0):
                ...
                self.assertRaises(
                    ValueError, headers.add_header, f"key{c0}", "val", param="param"
                )
                ...
                if c0 == "\t":
                    ...
                    self.assertRaises(
                        ValueError, headers.__setitem__, "key", f"val{c0}"
                    )
                    self.assertRaises(
                        ValueError, headers.add_header, "key", f"val{c0}", param="param"
                    )
                    self.assertRaises(
                        ValueError, headers.add_header, "key", "val", param=f"param{c0}"
                    )
