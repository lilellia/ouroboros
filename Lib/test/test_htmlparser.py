...
""",
    ...
    def test_style_content(self, content):
        ...
        self._run_check(
            s, [("starttag", "style", []), ("data", content), ("endtag", "style")]
        )
    ...
    @support.subTests(
        "tag", ["style", "xmp", "iframe", "noembed", "noframes", "script"]
    )
    ...
    def test_script_closing_tag(self, endtag):
        ...
        self._run_check(
            s,
            [("starttag", "script", []), ("data", content), ("endtag", "script")],
    ...
    def test_closing_tag(self, tag):
        for endtag in [
            ...
            self._run_check(
                ...
                collector=EventCollectorNoNormalize(
                    convert_charrefs=False, scripting=True
                ),
            )
    ...
    def test_invalid_closing_tag(self, tag):
        content = f"< /{tag}></ {tag}></{tag}x></{tag}\v></{tag}\xa0>"
    ...
    def test_eof_in_script(self, tail, end):
        ...
        self._run_check(
            s,
            [("starttag", "script", []), ("data", content if end else content + tail)],
            collector=EventCollectorNoNormalize(convert_charrefs=False),
        )
    ...
    def test_eof_in_title(self, tail, end):
        ...
        self._run_check(
            s,
            [("starttag", "title", []), ("data", "Egg & Spam" + ("" if end else tail))],
    ...
    def test_eof_in_cdata(self, content):
        self._run_check("<![CDATA[" + content, [("unknown decl", "CDATA[" + content)])
        self._run_check(
            "<![CDATA[" + content,
...
class AttributesTestCase(TestCaseBase):
    ...
    def test_attr_values(self):
        ...
        self._run_check(
            "<a b=\tx c=\ny>", [("starttag", "a", [("b", "x"), ("c", "y")])]
        )
        self._run_check(
            "<a b=\v c=\xa0>", [("starttag", "a", [("b", "\v"), ("c", "\xa0")])]
        )
