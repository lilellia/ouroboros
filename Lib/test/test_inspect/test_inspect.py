...
class TestClassesAndFunctions(unittest.TestCase):
    ...
    def test_getmembers_custom_dir(self):
        ...
        self.assertEqual(
            inspect.getmembers(cd, inspect.ismethod),
            [
                ("method", cd.method),
            ],
        )
    ...
    def test_getmembers_custom_broken_dir(self):
        ...
        self.assertEqual(
            inspect.getmembers(bd, inspect.ismethod),
            [
                ("method", bd.method),
            ],
        )
...
class TestSignatureObject(unittest.TestCase):
    ...
    def test_signature_on_non_comparable(self):
        ...
        self.assertEqual(
            self.signature(NoncomparableCallable()),
            ((("a", ..., ..., "positional_or_keyword"),), ...),
        )
...
class TestSignatureBind(unittest.TestCase):
    ...
    def test_signature_bind_positional_only(self):
        ...
        self.assertEqual(
            self.call(test, 1, 2, foo=4, bar=5, c_po=10), (1, 2, 3, 4, 5, {"c_po": 10})
        )

        self.assertEqual(
            self.call(test, 1, 2, 30, c_po=31, foo=4, bar=5),
            (1, 2, 30, 4, 5, {"c_po": 31}),
        )

        self.assertEqual(
            self.call(test, 1, 2, 30, foo=4, bar=5, c_po=31),
            (1, 2, 30, 4, 5, {"c_po": 31}),
        )

        self.assertEqual(self.call(test, 1, 2, c_po=4), (1, 2, 3, 42, 50, {"c_po": 4}))

        with self.assertRaisesRegex(
            TypeError, "missing a required positional-only argument: 'a_po'"
        ):
