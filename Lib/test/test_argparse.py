...
class TestOptionalsSingleDashAmbiguous(ParserTestCase):
    ...
    failures = ["-f", "-f a", "-fa", "-foa", "-foo", "-fo", "-foo b", "-f=a", "-foo=b"]
    successes = [
...
class TestInvalidArgumentConstructors(TestCase):
    ...
    def assertTypeError(self, *args, errmsg=None, **kwargs):
        parser = argparse.ArgumentParser()
        self.assertRaisesRegex(TypeError, errmsg, parser.add_argument, *args, **kwargs)

    def assertValueError(self, *args, errmsg=None, **kwargs):
        parser = argparse.ArgumentParser()
        self.assertRaisesRegex(ValueError, errmsg, parser.add_argument, *args, **kwargs)
    ...
    def test_invalid_action(self):
        ...
        self.assertValueError("--foo", action="store-true", errmsg="unknown action")
