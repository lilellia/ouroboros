...
class TestDateTime(TestDate):
    ...
    def test_strftime_special(self):
        ...
        self.assertEqual(
            t.strftime("\U0001f4bb%c\U0001f40d%B"), f"\U0001f4bb{s1}\U0001f40d{s2}"
        )
        self.assertEqual(
            t.strftime("%c\U0001f4bb%B\U0001f40d"), f"{s1}\U0001f4bb{s2}\U0001f40d"
        )
...
class TestTime(HarmlessMixedComparison, unittest.TestCase):
    ...
    def test_strftime_special(self):
        ...
        self.assertEqual(t.strftime("\U0001f40d"), "\U0001f40d")
        self.assertEqual(
            t.strftime("\U0001f4bb%I%p%Z\U0001f40d%X"), f"\U0001f4bb{s1}\U0001f40d{s2}"
        )
        self.assertEqual(
            t.strftime("%I%p%Z\U0001f4bb%X\U0001f40d"), f"{s1}\U0001f4bb{s2}\U0001f40d"
        )
        # Lone surrogates should pass through.
        self.assertEqual(t.strftime("\ud83d"), "\ud83d")
        self.assertEqual(t.strftime("\udc0d"), "\udc0d")
