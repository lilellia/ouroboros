...
class GlobTests(unittest.TestCase):
    ...
    def test_glob_directory_with_trailing_slash(self):
        ...
        for sep in seps:
            ...
            self.assertEqual(
                glob.glob(self.norm("aaa") + sep), [self.norm("aaa") + sep]
            )
            # Preserving the redundant separators is an implementation detail.
            self.assertEqual(
                glob.glob(self.norm("aaa") + sep * 2), [self.norm("aaa") + sep * 2]
            )
    ...
    def test_glob_bytes_directory_with_trailing_slash(self):
        ...
        for sep in seps:
            ...
            self.assertEqual(
                glob.glob(os.fsencode(self.norm("aaa") + sep)),
                [os.fsencode(self.norm("aaa") + sep)],
            )
            self.assertEqual(
                glob.glob(os.fsencode(self.norm("aaa") + sep * 2)),
                [os.fsencode(self.norm("aaa") + sep * 2)],
            )
            eq = self.assertSequencesEqual_noorder
            eq(
                glob.glob(os.fsencode(self.norm("aa*") + sep)),
                [
            ...
            eq(
                glob.glob(os.fsencode(self.norm("aa*") + sep * 2)),
                [
                    os.fsencode(self.norm("aaa") + os.sep),
                    os.fsencode(self.norm("aab") + os.sep),
                ],
