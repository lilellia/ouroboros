...
class ReTests(unittest.TestCase):
    ...
    def test_symbolic_groups_errors(self):
        self.checkPatternError(
            r"(?P<a>)(?P<a>)", "redefinition of group name 'a' as group 2; was group 1"
        )
    ...
    def test_word_boundaries(self):
        ...
        self.assertEqual(re.search(rb"\b(abc)\b", b"abc").group(1), b"abc")
        self.assertEqual(re.search(rb"\b(abc)\b", b"abc", re.LOCALE).group(1), b"abc")
        ...
        self.assertTrue(re.match(rb".\b", b"a="))
        self.assertTrue(re.match(rb".\b", b"a=", re.LOCALE))
        ...
        self.assertIsNone(re.match(rb".\b", b"ab"))
        self.assertIsNone(re.match(rb".\b", b"ab", re.LOCALE))
        ...
        self.assertIsNone(re.match(rb".\b", b"=-"))
        self.assertIsNone(re.match(rb".\b", b"=-", re.LOCALE))
        ...
        self.assertIsNone(re.match(rb".\B", b"a="))
        self.assertIsNone(re.match(rb".\B", b"a=", re.LOCALE))
        ...
        self.assertTrue(re.match(rb".\B", b"ab"))
        self.assertTrue(re.match(rb".\B", b"ab", re.LOCALE))
        ...
        self.assertTrue(re.match(rb".\B", b"=-"))
        self.assertTrue(re.match(rb".\B", b"=-", re.LOCALE))
        # There's a word boundary at the start of a string.
        self.assertTrue(re.match(r"\b", "abc"))
        self.assertTrue(re.match(r"\b", "abc", re.ASCII))
        self.assertTrue(re.match(rb"\b", b"abc"))
        self.assertTrue(re.match(rb"\b", b"abc", re.LOCALE))
        ...
        self.assertTrue(re.fullmatch(rb".+\b", b"abc"))
        self.assertTrue(re.fullmatch(rb".+\b", b"abc", re.LOCALE))
        ...
        self.assertEqual(re.search(rb"\B", b"abc").span(), (1, 1))
        self.assertEqual(re.search(rb"\B", b"abc", re.LOCALE).span(), (1, 1))
        ...
        self.assertIsNone(re.match(rb"\B", b"abc"))
        self.assertIsNone(re.match(rb"\B", b"abc", re.LOCALE))
        ...
        self.assertIsNone(re.fullmatch(rb".+\B", b"abc"))
        self.assertIsNone(re.fullmatch(rb".+\B", b"abc", re.LOCALE))
        ...
        self.assertIsNone(re.search(rb"\b", b""))
        self.assertIsNone(re.search(rb"\b", b"", re.LOCALE))
        ...
        self.assertEqual(len(re.findall(rb"\b", b"a")), 2)
        self.assertEqual(len(re.findall(rb"\b", b"a", re.LOCALE)), 2)
        self.assertEqual(len(re.findall(r"\B", "a")), 0)
        self.assertEqual(len(re.findall(r"\B", "a", re.ASCII)), 0)
        self.assertEqual(len(re.findall(rb"\B", b"a")), 0)
        self.assertEqual(len(re.findall(rb"\B", b"a", re.LOCALE)), 0)
        # If there are no words, there are no boundaries
        self.assertEqual(len(re.findall(r"\b", " ")), 0)
        self.assertEqual(len(re.findall(r"\b", " ", re.ASCII)), 0)
        self.assertEqual(len(re.findall(rb"\b", b" ")), 0)
        self.assertEqual(len(re.findall(rb"\b", b" ", re.LOCALE)), 0)
        self.assertEqual(len(re.findall(r"\b", "   ")), 0)
        self.assertEqual(len(re.findall(r"\b", "   ", re.ASCII)), 0)
        self.assertEqual(len(re.findall(rb"\b", b"   ")), 0)
        self.assertEqual(len(re.findall(rb"\b", b"   ", re.LOCALE)), 0)
        ...
        self.assertEqual(len(re.findall(rb"\B", b" ")), 2)
        self.assertEqual(len(re.findall(rb"\B", b" ", re.LOCALE)), 2)
    ...
    def test_ignore_case_range(self):
        ...
        self.assertIsNone(
            re.match(r"[\U00010428-\U0001044f]", "\U00010400", re.I | re.A)
        )
        self.assertIsNone(
            re.match(r"[\U00010400-\U00010427]", "\U00010428", re.I | re.A)
        )
    ...
    def test_possible_set_operations(self):
        ...
        with self.assertWarnsRegex(
            FutureWarning, "Possible set symmetric difference "
        ) as w:
            p = re.compile(r"[0-9~~1]")
        self.assertEqual(w.filename, __file__)
        self.assertEqual(p.findall(s), list("0123456789~"))
