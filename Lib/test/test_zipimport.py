...
class UncompressedZipImportTestCase(ImportHooksBaseTestCase):
    ...
    def doTest(self, expected_ext, files, *modules, call=None, **kw):
        ...
        if expected_ext:
            file = mod.get_file()
            self.assertEqual(file, os.path.join(zip_path, *modules) + expected_ext)
    ...
    def testBoth(self):
        files = {TESTMOD + ".py": test_src, TESTMOD + pyc_ext: test_pyc}
        self.doTest(pyc_ext, files, TESTMOD)
    ...
    def testBadMagic(self):
        ...
        files = {TESTMOD + ".py": test_src, TESTMOD + pyc_ext: badmagic_pyc}
        self.doTest(".py", files, TESTMOD)
    ...
    def testBadMTime(self):
        ...
        badtime_pyc[11] ^= 0x02
        files = {TESTMOD + ".py": test_src, TESTMOD + pyc_ext: badtime_pyc}
        self.doTest(".py", files, TESTMOD)
    ...
    def testPackage(self):
        ...
        files = {
            packdir + "__init__" + pyc_ext: test_pyc,
    ...
    def testSubNamespacePackage(self):
        ...
        files = {packdir: None, packdir2: None, packdir2 + TESTMOD + pyc_ext: test_pyc}
        self.doTest(pyc_ext, files, TESTPACK, TESTPACK2, TESTMOD)
    ...
    def testImporterAttr(self):
        ...
        files = {TESTMOD + pyc_ext: pyc, "some.data": "some data"}
    ...
    def testGetCompiledSource(self):
        ...
        files = {TESTMOD + ".py": test_src, TESTMOD + pyc_ext: pyc}
