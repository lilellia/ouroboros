...
class StandardTtkOptionsTests(StandardOptionsTests):
    ...
    def test_configure_relief(self):
        widget = self.create()
        self.checkReliefParam(widget, "relief", allow_empty=(tk_version >= (8, 7)))
...
class AbstractLabelTest(AbstractWidgetTest):
    ...
    test_configure_justify = requires_tk(8, 7)(
...
class ButtonTest(AbstractLabelTest, unittest.TestCase):
    ...
    def test_configure_default(self):
        ...
        self.checkEnumParam(widget, "default", *values, sort=tk_version >= (8, 7))
...
class MenubuttonTest(AbstractLabelTest, unittest.TestCase):
    ...
    def test_configure_direction(self):
        ...
        self.checkEnumParam(widget, "direction", *values, sort=tk_version >= (8, 7))
...
class ScaleTest(AbstractWidgetTest, unittest.TestCase):
    ...
    test_configure_state = requires_tk(8, 6, 9)(
        StandardTtkOptionsTests.test_configure_state
    )
...
class ProgressbarTest(AbstractWidgetTest, unittest.TestCase):
    ...
    test_configure_foreground = requires_tk(8, 7)(
        StandardOptionsTests.test_configure_foreground
    )
    test_configure_justify = requires_tk(8, 7)(
        StandardTtkOptionsTests.test_configure_justify
    )
    ...
    test_configure_wraplength = requires_tk(8, 7)(
        StandardOptionsTests.test_configure_wraplength
    )
...
class TreeviewTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def test_configure_columns(self):
        ...
        self.checkParam(
            widget, "columns", "", expected=() if tk_version >= (8, 7) else ""
        )
    ...
    def test_configure_displaycolumns(self):
        ...
        self.checkInvalidParam(
            widget, "displaycolumns", (1, 2, 3), errmsg=errmsg.format(3)
        )
        self.checkInvalidParam(
            widget, "displaycolumns", (1, -2), errmsg=errmsg.format(-2)
        )
