...
class Test_pygettext(unittest.TestCase):
    ...
    def extract_docstrings_from_str(self, module_content):
        ...
        return self.extract_from_str(
            module_content, args=("--docstrings",), strict=False
        )
...
def extract_from_snapshots():
    ...
    for filename, args in snapshots.items():
        ...
        with temp_cwd(None):
            ...
            assert_python_ok("-Xutf8", Test_pygettext.script, *args, input_file.name)
            yield (
                input_file,
                output_file,
