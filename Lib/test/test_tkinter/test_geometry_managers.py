...
class PlaceTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def test_place_configure_x(self):
        ...
        with self.assertRaisesRegex(
            TclError, EXPECTED_SCREEN_DISTANCE_ERRMSG.format("spam")
        ):
    ...
    def test_place_configure_width(self):
        ...
        with self.assertRaisesRegex(
            TclError, EXPECTED_SCREEN_DISTANCE_OR_EMPTY_ERRMSG.format("abcd")
        ):
    ...
    def test_place_configure_relwidth(self):
        ...
        self.assertEqual(f2.winfo_width(), 30)
        with self.assertRaisesRegex(
            TclError, EXPECTED_FLOAT_OR_EMPTY_ERRMSG.format("abcd")
        ):
...
class GridTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def test_grid_columnconfigure_minsize(self):
        with self.assertRaisesRegex(
            TclError, EXPECTED_SCREEN_DISTANCE_ERRMSG.format("foo")
        ):
    ...
    def test_grid_location(self):
        ...
        with self.assertRaisesRegex(
            TclError, EXPECTED_SCREEN_DISTANCE_ERRMSG.format("x")
        ):
            self.root.grid_location("x", "y")
        with self.assertRaisesRegex(
            TclError, EXPECTED_SCREEN_DISTANCE_ERRMSG.format("y")
        ):
