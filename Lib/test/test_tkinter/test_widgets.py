...
EXPECTED_SCREEN_DISTANCE_OR_EMPTY_ERRMSG = (
    '(bad|expected) screen distance (or "" but got )?"{}"'
)
...
class PanedWindowTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def test_configure_proxyrelief(self):
        widget = self.create()
        self.checkReliefParam(widget, "proxyrelief", allow_empty=(tk_version >= (8, 7)))
    ...
    def test_paneconfigure_height(self):
        ...
        self.check_paneconfigure_bad(
            p, b, "height", EXPECTED_SCREEN_DISTANCE_OR_EMPTY_ERRMSG.format("badValue")
        )
    ...
    def test_paneconfigure_minsize(self):
        ...
        self.check_paneconfigure_bad(
            p, b, "minsize", EXPECTED_SCREEN_DISTANCE_ERRMSG.format("badValue")
        )
    ...
    def test_paneconfigure_padx(self):
        ...
        self.check_paneconfigure_bad(
            p, b, "padx", EXPECTED_SCREEN_DISTANCE_ERRMSG.format("badValue")
        )
    ...
    def test_paneconfigure_pady(self):
        ...
        self.check_paneconfigure_bad(
            p, b, "pady", EXPECTED_SCREEN_DISTANCE_ERRMSG.format("badValue")
        )
    ...
    def test_paneconfigure_width(self):
        ...
        self.check_paneconfigure_bad(
            p, b, "width", EXPECTED_SCREEN_DISTANCE_OR_EMPTY_ERRMSG.format("badValue")
        )
...
class MenuTest(AbstractWidgetTest, unittest.TestCase):
    ...
    test_configure_activerelief = requires_tk(8, 7)(
        StandardOptionsTests.test_configure_activerelief
    )
