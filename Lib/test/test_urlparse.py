...
class UrlParseTestCase(unittest.TestCase):
    ...
    def test_invalid_bracketed_hosts(self):
        ...
        self.assertRaises(
            ValueError, urllib.parse.urlsplit, "scheme://prefix.[v6a.ip]/"
        )
        self.assertRaises(
            ValueError, urllib.parse.urlsplit, "scheme://[v6a.ip].suffix/"
        )
        self.assertRaises(
            ValueError, urllib.parse.urlsplit, "scheme://prefix.[v6a.ip]?"
        )
        ...
        self.assertRaises(ValueError, urllib.parse.urlsplit, "scheme://prefix.[::1]:?")
        self.assertRaises(
            ValueError, urllib.parse.urlsplit, "scheme://user@prefix.[v6a.ip]"
        )
        self.assertRaises(
            ValueError, urllib.parse.urlsplit, "scheme://user@[v6a.ip].suffix"
        )
        ...
        self.assertRaises(ValueError, urllib.parse.urlsplit, "scheme://v6a.ip].suffix")
        self.assertRaises(
            ValueError, urllib.parse.urlsplit, "scheme://prefix]v6a.ip[suffix"
        )
        self.assertRaises(ValueError, urllib.parse.urlsplit, "scheme://prefix]v6a.ip")
        self.assertRaises(ValueError, urllib.parse.urlsplit, "scheme://v6a.ip[suffix")
