...
class CompileallTestsBase:
    ...
    def test_compile_file_pathlike_ddir(self):
        ...
        self.assertTrue(
            compileall.compile_file(
                FakePath(self.source_path), ddir=FakePath("ddir_path"), quiet=2
            )
        )
        self.assertTrue(os.path.isfile(self.bc_path))
    ...
    def test_compile_file_pathlike_stripdir(self):
        ...
        self.assertTrue(
            compileall.compile_file(
                FakePath(self.source_path), stripdir=FakePath("stripdir_path"), quiet=2
            )
        )
        self.assertTrue(os.path.isfile(self.bc_path))
    ...
    def test_compile_dir_pathlike_stripdir(self):
        ...
        self.assertTrue(
            compileall.compile_dir(
                FakePath(self.directory), stripdir=FakePath("stripdir_path"), quiet=2
            )
        )
        self.assertTrue(os.path.isfile(self.bc_path))
