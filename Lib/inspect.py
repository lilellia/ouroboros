...
__all__ = [
    ...
    "CORO_RUNNING",
    "CORO_SUSPENDED",
    "CO_ASYNC_GENERATOR",  # noqa: F822
    "CO_COROUTINE",  # noqa: F822
    "CO_GENERATOR",  # noqa: F822
    "CO_ITERABLE_COROUTINE",  # noqa: F822
    "CO_NESTED",  # noqa: F822
    "CO_NEWLOCALS",  # noqa: F822
    "CO_NOFREE",  # noqa: F822
    "CO_OPTIMIZED",  # noqa: F822
    "CO_VARARGS",  # noqa: F822
    "CO_VARKEYWORDS",  # noqa: F822
    "GEN_CLOSED",
    "GEN_CREATED",
    "GEN_RUNNING",
    "GEN_SUSPENDED",
...
def get_annotations(obj, *, globals=None, locals=None, eval_str=False):
    ...
    if not isinstance(ann, dict):
        raise ValueError(f"{obj!r}.__annotations__ is neither a dict nor None")  # noqa: TRY004
...
def iscoroutinefunction(obj):
    ...
    """
    return _has_code_flag(obj, CO_COROUTINE) or _has_coroutine_mark(obj)  # noqa: F821
...
def getframeinfo(frame, context=1):
    ...
    if positions[0] is None:
        ...
        frame, *positions = (frame, *positions)  # noqa: PLW0127
...
def getattr_static(obj, attr, default=_sentinel):
    ...
    if instance_result is not _sentinel and klass_result is not _sentinel:  # noqa: SIM102
