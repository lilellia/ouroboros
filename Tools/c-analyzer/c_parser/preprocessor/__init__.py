...
def preprocess(
    ...
    *,
    ...
    if tool:
        ...
        with _good_file(source, filename) as source:  # noqa: PLR1704
            return (
                _preprocess(
                    source,
                    incldirs,
...
def _resolve_samefile(filename, pattern, suffix):
    ...
    if os.path.basename(pattern) == "*" or os.path.basename(relpattern) == "*" + suffix:
...
from .common import FileInfo, SourceLine  # noqa: F401
from .errors import (
    ErrorDirectiveError,  # noqa: F401
    MissingDependenciesError,  # noqa: F401
    OSMismatchError,  # noqa: F401
    PreprocessorError,  # noqa: F401
    PreprocessorFailure,  # noqa: F401
)
