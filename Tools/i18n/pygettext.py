...
def make_escapes(pass_nonascii):
    ...
    escapes = [r"\%03o" % i for i in range(mod)]  # noqa: UP031
...
def main():
    ...
    for filename in args:
        ...
        try:
            ...
            try:
                ...
                print(
                    "%s: %s, line %d, column %d"  # noqa: UP031
    ...
    if options.outfile == "-":
        ...
        fp = open(options.outfile, "w")  # noqa: SIM115
        closep = 1
    try:
        eater.write(fp)
    finally:
