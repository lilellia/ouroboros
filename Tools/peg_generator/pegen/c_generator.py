...
class CParserGenerator(ParserGenerator, GrammarVisitor):
    ...
    def generate(self, filename: str) -> None:
        ...
        if trailer:
            self.print(trailer.rstrip("\n") % {"mode": mode, "modulename": modulename})
    ...
    def _setup_keywords(self) -> None:
        ...
        with self.indent():
            ...
            for keywords_length in range(num_groups):
                if keywords_length not in groups:
    ...
    def visit_Rhs(self, node: Rhs, is_loop: bool, is_gather: bool, rulename: str | None) -> None:
        if is_loop:
    ...
    def visit_Alt(self, node: Alt, is_loop: bool, is_gather: bool, rulename: str | None) -> None:
